...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`upwork like application for QAs`}</title>

        <meta
          name="description"
          content="Welcome to Upwork like application for QAs - Where Quality Assurance Professionals Meet Their Perfect Projects. Discover Your Potential Today!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1570215170761-f056128eda48?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxRQXxlbnwwfHx8fDE2OTk1MjA3NzZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@zanilic?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Zan`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`upwork like application for QAs`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Upwork like application for QAs - Where Quality Assurance Professionals Meet Their Perfect Projects. Discover Your Potential Today!`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="QA Manager" type="qa-manager" abilities={appConfig.ownerAbilities} />
