...
export function TaskListPage(props: TaskListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['project', 'bug_report.count', 'test_case.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('project', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('bug_report', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'bug_report',
          header: 'Bug Report',
          accessorKey: 'bug_report',
          cell: ({ row: { original: record } }: any) => record?._count?.bug_report,
        }
      : null,
